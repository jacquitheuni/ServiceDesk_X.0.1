    ...
    public class RoleController : Controller
    {
        ...
        public ActionResult Create([Bind(Include ="RoleName")]RoleViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                //if (context.RoleExists(_roleManager, model.RoleName))
                //{
                //    return View(message);
                //}
                //else
        ...
        public ActionResult Edit(string id)
        {
            ...
            var role = context.Roles.First(r => r.Name == id);
            ...
            "RoleName,OriginalRoleName,Description")] EditRoleViewModel model)
        {
            if (ModelState.IsValid)
            {
                var role = context.Roles.First(r => r.Name == model.OriginalRoleName);
        ...
        //    context.DeleteRole(context, userManager, role.Id);
        //    return RedirectToAction("Index");
        //}
    }
}